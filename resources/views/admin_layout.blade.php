              ...
              {{--   <li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/add-import-warehouse')}}">Thêm sản phẩm theo kho</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-warehouse')}}">Kho hàng</a></li>
                        <li><a href="{{URL::to('/all-warehouse')}}">Liệt kê kho hàng</a></li>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let data = $('#chartBar').data('data');
        let chartBar =Morris.Bar({
            element: 'chartBar',
            data: data,
            xkey: 'date',
        ...
        $('.select-chart-filter').change(function(){
            var type = $(this).val();
            var _token = $('input[name="_token"]').val();
            // alert(dashboard_value);
            $.ajax({
