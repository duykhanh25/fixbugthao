                    ...
                    <div class="col-sm-8">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i><span style="color:black"> Hỗ trợ khách hàng:</span> 0963937375 | </a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> kowilcskh@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        $(document).ready(function(){
            ...
            $('.add-to-cart').click(function(){
               ...
               // alert(id);
                ...
                var _token = $('input[name="_token"]').val();
                var warehouse = $('.select-warehouse').find(":selected").val();

                var soluongtontai = $('.soluongtontai').val();

                if(parseInt(cart_product_qty)>parseInt(cart_product_quantity)){
                    alert('Làm ơn đặt nhỏ hơn ' + cart_product_quantity);
                }else if(warehouse==0){
                    alert('Làm ơn chọn kho đặt hàng');
                }else if(parseInt(cart_product_qty) > parseInt(soluongtontai)){
                    alert('Số lượng trong kho không đủ,vui lòng đặt ít hơn');
                }else{

                    $.ajax({
                        url: '{{url('/add-cart-ajax')}}',
                        method: 'POST',
                        data:{cart_product_id:cart_product_id,cart_product_name:cart_product_name,cart_product_image:cart_product_image,cart_product_price:cart_product_price,cart_product_qty:cart_product_qty,_token:_token,cart_product_quantity:cart_product_quantity,warehouse:warehouse},
                        success:function(){
