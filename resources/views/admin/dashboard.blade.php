...
<div class="row">
		...
		<form autocomplete="off">
			...
			<div class="col-md-2">
				...
				<input type="button" id="btn-chart-filter" class="btn btn-primary btn-sm" value="Lọc kết quả">
			...
			<div class="col-md-2">
				<p>
					Lọc theo:
					<select class="select-chart-filter form-control" >
    ...
    <div class="col-md-12">
        <div id="chartBar" data-data="{{json_encode($statisticSaleOrders)}}" style="height: 250px;"></div>
