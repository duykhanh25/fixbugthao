...
class ProductController extends Controller
{
   ...
   public function file_browser(Request $request){
    ...
    public function add_product(){
        ...
        $warehouse =  DB::table('tbl_warehouse')->orderby('id','desc')->get(); 

        return view('admin.add_product')->with('cate_product', $cate_product)->with('brand_product',$brand_product)->with('warehouse',$warehouse);
    ...
    public function edit_product($product_id){
        ...
        $manager_product  = view('admin.edit_product')->with('edit_product',$edit_product)->with('cate_product',$cate_product)->with('brand_product',$brand_product)->with('warehouse',$warehouse);
