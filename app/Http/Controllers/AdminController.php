...
class AdminController extends Controller
{
    ...
    public function callback_customer_google()
    {
        ...
        return redirect('/dang-nhap')->with(
            'message',
            'Đăng nhập bằng tài khoản google <span style="color:red">'.$account_name->customer_email.'</span> thành công'
        );
    }
    ...
    public function callback_facebook_customer()
    {
        ...
        if ($account != null) {
            ...
            return redirect('/dang-nhap')->with(
                'message',
                'Đăng nhập bằng tài khoản facebook <span style="color:red">'.$account_name->customer_email.'</span> thành công'
            );
        } elseif ($account == null) {
            ...
            return redirect('/dang-nhap')->with(
                'message',
                'Đăng nhập bằng tài khoản facebook <span style="color:red">'.$account_new->customer_email.'</span> thành công'
            );
        }
    }
    ...
    public function show_dashboard(Request $request)
    {
        ...
        $statisticSaleOrders = $this->__getDataChart($startDate, $endDate);
        $this->AuthLogin();
        //get ip address
    ...
    public function filterChartData(Request $request)
    {
        ...
        $data = $this->__getDataChart($startDate, $endDate);
