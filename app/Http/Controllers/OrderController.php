...
class OrderController extends Controller
{
	...
	public function print_order_convert($checkout_code){
		...
		if($product_coupon != 'no' and $product_coupon){
		...
		foreach($order_details_product as $key => $product){
			...
			if($product->product_coupon!='no' and $product->product_coupon){
	...
	public function view_order($order_code){
		...
		$customer = Customer::where('customer_id',$customer_id)->first();
		$shipping = Shipping::where('shipping_id',$shipping_id)->first();
		$warehouse = DB::table('tbl_warehouse')->where('status','0')->orderby('id','desc')->get();
		$ware_pro = DB::table('warehouse_product')->orderby('id','desc')->get();
		...
		return view('admin.view_order')->with(compact('order_details','customer','shipping','coupon_condition','coupon_number','getorder','order_status','warehouse','ware_pro'));
