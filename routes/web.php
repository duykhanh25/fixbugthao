...
Route::post('/filter-chart','AdminController@filterChartData');
...
Route::post('/save-warehouse','WarehouseController@save_warehouse');
Route::post('/update-warehouse/{id}','WarehouseController@update_warehouse');

Route::post('/add-ware-pro/','WarehouseController@add_ware_pro');
Route::post('/select-warehouse/','WarehouseController@select_warehouse');

Route::get('/delete-ware-pro/{id}','WarehouseController@delete_ware_pro');
...
Route::get('/all-warehouse','WarehouseController@all_warehouse');
Route::get('/add-import-warehouse','WarehouseController@add_import_warehouse');
